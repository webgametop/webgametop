...
<ul class="nav nav-bordered text-uppercase my-4">
    <li class="nav-item flex-grow-1">
        <a @class([
            'nav-link', 'active' => request()->routeIs('developers.show')
    ...
    <li class="nav-item">
        <a @class([
            'nav-link', 'active' => request()->routeIs('developers.games')
    ...
    <li class="nav-item">
        <a @class([
            'nav-link', 'active' => request()->routeIs('developers.comments')
        ]) href="{{ route('developers.comments', [$developer, $developer->slug]) }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon me-2 icon-2">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
