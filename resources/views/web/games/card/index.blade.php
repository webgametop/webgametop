                ...
                <div class="col-12 col-lg-5 d-flex flex-column mt-4 mt-lg-0">
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="d-flex align-items-center mt-3" style="height: 55px;">
                            ...
                            @endauth
                            <div class="card h-100 w-100" title="0 плюсов / 0 минусов">
                                @auth
                                    <form action="{{ route('ratings.store') }}" method="post" @class([
                                        ...
                                        <button type="submit" class="btn btn-link p-0 ms-1" title="Поставить плюсик">
                                        ...
                                        <div>0</div>
                                        <button type="submit" class="btn btn-link p-0 me-1" title="Поставить минус">
                                ...
                                @else
                                    <div class="card-body text-center">0</div>
                                @endauth
                            </div>
                        </div>
                    </div>
