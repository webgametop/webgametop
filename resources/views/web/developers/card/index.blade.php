                    ...
                    @auth
                        ...
                        @else
                            <form action="{{ route('ratings.store') }}" method="post" @class([
                                ...
                                <button type="submit" class="btn btn-link p-0" name="rate" value="upvote" title="Поставить плюсик" data-loading-text>
                                ...
                                <div>{{ $rate }}</div>
                                <button type="submit" class="btn btn-link p-0" name="rate" value="downvote" title="Поставить минус" data-loading-text>
                ...
                @auth
                    <div class="ms-md-auto ms-0">
                        ...
                        <form action="{{ route('favorites.toggle') }}" method="post">
                            @csrf
                            <input type="hidden" name="favoriteable[type]" value="{{ morph_alias($developer::class) }}" autocomplete="off">
